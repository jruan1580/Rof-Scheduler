    ...
    public class CookieActionFilter : ActionFilterAttribute
    {
        public override void OnActionExecuted(ActionExecutedContext context)
        {
            ...
            if (context.HttpContext.Request.Cookies.ContainsKey("X-Access-Token-Client"))
            {
                ...
                context.HttpContext.Response.Cookies.Append("X-Access-Token-Client", cookie, new CookieOptions() { HttpOnly = true, SameSite = SameSiteMode.None, Secure = true, Path = "/", Expires = DateTimeOffset.Now.AddMinutes(30) });
            }
        }
    }
}
