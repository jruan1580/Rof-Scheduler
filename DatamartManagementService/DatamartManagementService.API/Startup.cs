using DatamartManagementService.Infrastructure.Persistence;
...
namespace DatamartManagementService.API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSingleton<IPayrollDetailRetrievalRepository, PayrollDetailRetrievalRepository>();
