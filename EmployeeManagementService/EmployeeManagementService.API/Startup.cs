...
namespace EmployeeManagementService.API
{
    public class Startup
    {
        ...
        {
            services.AddSingleton<IEmployeeRetrievalRepository, EmployeeRetrievalRepository>();
            services.AddSingleton<IEmployeeUpsertRepository, EmployeeUpsertRepository>();
