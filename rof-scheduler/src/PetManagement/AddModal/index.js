...
function AddPetModal({ show, handleHide, handleAddPetSuccess, setLoginState }) {
  ...
  return (
    <>
            ...
            <Modal.Body>
              <Form onSubmit={goToAddPet}>
                <Form.Group as={Row}>
                  ...
                  <Col lg={9}>
                    <Form.Select type="select" name="petType">
      ...
      {petTypeSelected !== undefined && (
        <Modal show={show} onHide={closeModal} dialogClassName="add-modal80">
            ...
            <Form onSubmit={addPetSubmit}>
              ...
              {successMsg && (
                <Alert variant="success">
                  Pet successfully added! Page will reload in 3 seconds and new
                  pet will be available....
                </Alert>
              )}
              ...
              {!loading && !disableBtns && (
                <Button
                  type="button"
                  className="float-end"
                  onClick={() => setPetTypeSelected(undefined)}
                >
                  Back
                </Button>
              )}
