...
import { updateClientInformation } from "../../SharedServices/clientManagementService";
...
function UpdateUserModal({
  ...
  const handleUpdate = (e) => {
    ...
    if (userType === "Employee") {
      ...
      //client
      inputValidations = ensureClientUpdateInformationProvided(
        firstName,
        lastName,
        email,
        username,
      ...
      >
        ...
        <Modal.Body>
          <Form onSubmit={handleUpdate}>
            ...
            {successMsg && (
              <Alert variant="success">{userType} successfully updated.</Alert>
            )}
