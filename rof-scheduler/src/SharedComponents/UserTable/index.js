            ...
            users.map((user) => {
              return (
                <tr key={user.id}>
                  ...
                  {userType == "Employee" && (
                    <td>
                      {userType == "Employee" && user.active ? "Yes" : "No"}
                    </td>
                  )}
                  {user.isLocked && (
                    <td>
                      <OverlayTrigger
                        placement="top"
                        overlay={<Tooltip>Lock</Tooltip>}
                      >
                        <Button onClick={() => resetUserLockStatus(user.id)}>
                          <svg
                  ...
                  {userType == "Employee" && user.active && (
                    <td>
                      ...
                      >
                        <Button
                          onClick={() =>
                            updateEmployeeActiveStatus(user.id, false)
                          }
                        >
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                  ...
                  {userType == "Employee" && !user.active && (
                    <td>
                      ...
                      >
                        <Button
                          onClick={() =>
                            updateEmployeeActiveStatus(user.id, true)
                          }
                        >
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
