...
export const ensureUpdateInformationProvided = function(firstName, 
    lastName, 
    ssn, 
    role, 
    username, 
    ...
    if (ssn == undefined || ssn === ''){
        validationErrors.set('ssn', 'Please enter your last ssn.');  
    }

    if (role == undefined || role === ''){
        validationErrors.set('role', 'Please enter your last role.');  
    }
    ...
    if (zipCode == undefined || zipCode === ''){
        validationErrors.set('zipCode', 'Please enter your zip code.');  
    }
