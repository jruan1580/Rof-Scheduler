export const validateLoginPassword = function (password) {
  ...
  if (!lowerCaseLetters.test(password) || !upperCaseLetters.test(password) || !numbers.test(password) || !specialChars.test(password)){
    errMsg = "Ensure that password has lower AND upper cases characters, digits, and special characters.";
    return errMsg;
  }
