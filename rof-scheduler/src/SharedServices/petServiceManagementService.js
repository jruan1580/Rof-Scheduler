...
export const updatePetService = async function(id, name, rate, employeeRate, description, duration, timeUnit){
    var baseUrl = process.env.REACT_APP_PET_SERVICE_BASE_URL + "/petservice";

    var data = { id, name, rate, employeeRate, description, duration, timeUnit };
